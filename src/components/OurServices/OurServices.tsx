        ...
        >
          ...
          >
            ...
            <UnorderedList>
              ...
              <ListItem>
                {types.Features.descricaoBeneficio2}
              </ListItem>
              <ListItem>
                {types.Features.descricaoBeneficio3}
              </ListItem>
              <ListItem>
                {types.Features.descricaoBeneficio4}
              </ListItem>
              <ListItem>
                {types.Features.descricaoBeneficio5}
              </ListItem>
              <ListItem>
                {types.Features.descricaoBeneficio6}
              </ListItem>
              <ListItem>
                {types.Features.descricaoBeneficio7}
              </ListItem>
            </UnorderedList>
          </Feature>
          ...
          <Feature
            color="pink"
            title={types.Features.beneficiosAssistencias}
            icon={
              <path
                fillRule="evenodd"
          ...
          >
            {types.Features.descricaoBeneficiosAssistencias}
          </Feature>

          <Feature
            color="yellow"
            title={types.Features.planejamentoAposentadoria}
            icon={
              <path
                fillRule="evenodd"
          ...
          >
            {types.Features.descricaoPlanejamento}
          </Feature>

          <Feature
            color="green"
            title={types.Features.revisaoDaVida}
            icon={
              <>
                <path
                  fillRule="evenodd"
          ...
          >
            {types.Features.descricaoRevisaoDaVida}
          </Feature>
          <Feature
            color="purple"
            title={types.Features.calculosPrevidenciarios}
            icon={
              <path
                fillRule="evenodd"
          ...
          >
            {types.Features.descricaoCalculosPrevidenciarios}
          </Feature>
          <Feature
            color="blue"
            title={types.Features.acoesJudiciais}
            icon={
              <path
                fillRule="evenodd"
          ...
          >
            {types.Features.descricaoAcoesJudiciais}
          </Feature>
          {/* <Feature
            color="brand"
